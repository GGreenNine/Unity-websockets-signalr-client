...
// Assembly location: D:\work project\Stereo\Assets\JsonDotNet\Assemblies\Standalone\Newtonsoft.Json.dll
  ...
  public class VectorConverter : JsonConverter
  {
      ...
      JsonSerializer serializer)
    {
      ...
      if (objectType == VectorConverter.V3)
        return (object) VectorConverter.PopulateVector3(reader);
      return (object) VectorConverter.PopulateVector4(reader);
    }
